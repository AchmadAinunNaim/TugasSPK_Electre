function displayAlternatives(alternatives) {
    ...
    table.style.border = "2px solid #00FFFF"; // Atur batas untuk seluruh tabel
    ...
    nameHeader.style.color = "#00FFFF"; // Atur warna teks
    ...
    alternatives.forEach(function(alternative) {
        ...
        idCell.style.color = "#00FFFF"; // Atur warna teks
        ...
        nameCell.style.color = "#00FFFF"; // Atur warna teks
    ...
    heading.style.color = "#00FFFF"; // Ganti warna font
...
function displayCriterias(criterias) {
    ...
    headerColumns.forEach(function(columnText) {
        ...
        headerCell.style.border = "2px solid #00FFFF"; // Atur batas untuk seluruh sel
        headerCell.style.color = "	#00FFFF"; // Atur warna teks
    ...
    criterias.forEach(function(criteria) {
        ...
        idCell.style.border = "2px solid #00FFFF"; // Atur batas untuk seluruh sel
        idCell.style.color = "##00FFFF"; // Atur warna teks
        var criteriaCell = document.createElement("td");
        criteriaCell.textContent = criteria.criteria;
        criteriaCell.style.border = "2px solid #00FFFF"; // Atur batas untuk seluruh sel
        criteriaCell.style.color = "##00FFFF"; // Atur warna teks
        var weightCell = document.createElement("td");
        weightCell.textContent = criteria.weight;
        weightCell.style.border = "2px solid #00FFFF"; // Atur batas untuk seluruh sel
        weightCell.style.color = "##00FFFF"; // Atur warna teks
...
function displayResultN(n) {
    ...
    element.innerHTML += '<h4 class="text-center m-0" style="color: #00FFFF;">' + n + ' Kriteria</h3>';
}

function displayResultM(m) {
    var element = document.getElementById("m");
    element.innerHTML += '<h4 class="text-center m-0" style="color: #00FFFF;">' + m + ' Alternatif</h3>';
}
...
function displayResultX(x) {
    ...
    heading.style.color = "#00FFFF"; // Change font color
    ...
    categoryCell.style.color = "##00FFFF"; // Change font color
    ...
    for (var criterion in x[1]) {
        ...
        headerCell.style.color = "##00FFFF"; // Change font color
    ...
    for (var alternative in x) {
        ...
        altCell.classList.add("text-center");
        altCell.style.color = "##00FFFF"; // Change font color
        altCell.style.border = "2px solid #F0F8FF"; // Add border to Alternatif cell
        ...
        for (var value in x[alternative]) {
            ...
            cell.style.color = "##00FFFF"; // Change font color
...
function displayResultX_Rata(x_rata) {
    ...
    table.style.color = "##00FFFF"; // Set the font color
...
function displayResultCriteria(criteria) {
    ...
    title.style.color = "##00FFFF"; // Change font color
    ...
    table.style.color = "##00FFFF"; // Change font color
...
function displayResultC(c) {
    ...
    table.style.border = "2px solid #F0F8FF"; // Atur batas untuk seluruh tabel
    table.style.color = "##00FFFF"; // Atur warna teks untuk seluruh tabel
    ...
    criteriaHeaderCell.style.color = "##00FFFF"; // Atur warna teks untuk seluruh sel
    headerRow.appendChild(criteriaHeaderCell);
    ...
    for (var criterion in c[1]) {
        ...
        headerCell.style.color = "##00FFFF"; // Atur warna teks untuk seluruh sel
        headerRow.appendChild(headerCell);
    }
    ...
    for (var criterion in c) {
        ...
        criterionCell.style.color = "##00FFFF"; // Atur warna teks untuk seluruh sel
        ...
        for (var value in c[criterion]) {
            ...
            cell.style.color = "##00FFFF"; // Atur warna teks untuk seluruh sel
...
function displayResultThreshold_C(threshold_c) {
    ...
    element.innerHTML += '<h4 class="text-center m-0" style="color: ##00FFFF;">' + threshold_c + ' Threshold c</h3>';
}
...
function displayResultThreshold_D(threshold_d) {
    ...
    element.innerHTML += '<h4 class="text-center m-0" style="color: ##00FFFF;">' + threshold_d + ' Threshold d</h3>';
}
...
function displayResultConclusion(conclusionMatrix) {
    ...
    headingDapat.style.color = "##00FFFF"; // Ganti warna font
    ...
    headingTidak.style.color = "##00FFFF"; // Ganti warna font
    ...
    for (var row in conclusionMatrix) {
        for (var col in conclusionMatrix[row]) {
            if (conclusionMatrix[row][col] === 1) {
                ...
                listItem.style.color = "##00FFFF"; // Atur warna teks
